...
//                    new FileInputStream(
//                            new File( "config/ors_connector.cfg" )));
...
//        //ConnectToExchangeApplication application = new ConnectToExchangeApplication()
//        MessageStoreFactory messageStoreFactory = new FileStoreFactory(settings);
//        LogFactory logFactory = new ScreenLogFactory(true, true, true, logHeartbeats);
//        MessageFactory messageFactory = new DefaultMessageFactory();
//
//        initiator = new SocketInitiator(messageStoreFactory, settings, logFactory, messageFactory);
///*
