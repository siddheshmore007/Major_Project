...
public class OrderRoutingApplication extends MessageCracker implements Application {
    ...
    public OrderRoutingApplication(SessionSettings settings,
    ...
    public void onLogon(SessionID sessionID) {
        ...
        if (connectedStatus != null)
            connectedStatus.setIcon(new javax.swing.ImageIcon(getClass()
                    .getResource("/serve/ors/ui/green.gif")));
    }
    ...
    public void onLogout(SessionID sessionID) {
        ...
        currentSession = null;
        connectedStatus.setIcon(new javax.swing.ImageIcon(getClass()
                .getResource("/serve/ors/ui/red.gif")));
    }
...
//            try {
//                autoAck = settings.getBool("OrderRoutingAutoAcknowledge");
//            } catch (Exception e) {
//            }
//            if (autoAck) {
//                acknowledge(order);
...
//    }
    ...
    public void sendMessage(Message message) {
        ...
        try {
            ...
            sendoboCompID = settings.getBool("OrderRoutingSendOnBehalfOfCompID");
            sendoboSubID = settings.getBool("OrderRoutingSendOnBehalfOfSubID");
        } catch (Exception e) {
        }
