...
public class ConnectToExchangeApplication implements Application {
...
//
//
    public ConnectToExchangeApplication(MessageTableModel conMessageTableModel) {
        this.messageTableModel = conMessageTableModel;
...
////            return;
////
////        Order order = OrderTableModel.getValueAt(.getField(new ClOrdID()).getValue());
////        if (order == null) {
////            return;
////        }
////
